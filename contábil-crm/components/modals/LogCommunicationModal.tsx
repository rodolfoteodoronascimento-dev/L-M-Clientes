                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="type" value={type} onChange={e => setType(e.target.value as CommunicationType)} className="mt-1 block w-full bg-zinc-100 dark:bg-zinc-800 border-zinc-300 dark:border-zinc-700 rounded-md py-2 px-3 text-black dark:text-white focus:ring-primary focus:border-primary">
                        ...
                        <div>
                            ...
                            <input type="text" id="subject" value={subject} onChange={e => setSubject(e.target.value)} className="mt-1 block w-full bg-zinc-100 dark:bg-zinc-800 border-zinc-300 dark:border-zinc-700 rounded-md py-2 px-3 text-black dark:text-white focus:ring-primary focus:border-primary" required />
                        </div>
                    </div>
                    <div>
                        <label htmlFor="content" className="block text-sm font-medium text-zinc-600 dark:text-zinc-300">Resumo</label>
                        <textarea id="content" value={content} onChange={e => setContent(e.target.value)} rows={4} className="mt-1 block w-full bg-zinc-100 dark:bg-zinc-800 border-zinc-300 dark:border-zinc-700 rounded-md py-2 px-3 text-black dark:text-white focus:ring-primary focus:border-primary" required />
                    </div>
